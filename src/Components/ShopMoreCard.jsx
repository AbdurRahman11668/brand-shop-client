const ShopMoreCard = () => {
  return (
    <div className="flex pb-20 px-20 space-x-5 ">
      <div className="relative w-[50%] cursor-pointer">
        ...
        <div className="absolute top-10 left-10 space-y-3">
          <p className="text-xl font-semibold text-sky-500">NEW TECHNOLOGIES</p>
          <h3 className="text-3xl font-bold">WEBCAMS 2023</h3>
      ...
      <div className="relative w-[50%] cursor-pointer">
        ...
        <div className="absolute top-10 left-10 space-y-3">
          <p className="text-xl font-semibold text-gray-300">APPLE ACCESSORIES</p>
          <h3 className="text-4xl font-bold text-white">Best Laptop</h3>
